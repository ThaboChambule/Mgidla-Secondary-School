      ...
      <div className={`py-2 px-4 transition-all duration-300 ${
        ...
        <div className="container mx-auto flex justify-between items-center text-sm">
          ...
          <div className="flex space-x-4 md:space-x-6 text-xs md:text-sm w-full md:w-auto justify-end">
            <Link href="/register" className="hover:text-blue-200 transition-colors flex items-center group">
              <UserPlus className="h-3 w-3 md:h-4 md:w-4 mr-1 group-hover:scale-110 transition-transform" />
              <span>Register</span>
            </Link>
            <Link href="/myhub" className="hover:text-blue-200 transition-colors flex items-center group">
              <LogIn className="h-3 w-3 md:h-4 md:w-4 mr-1 group-hover:scale-110 transition-transform" />
              <span>Sign in</span>
            </Link>
            <Link href="/contact" className="hover:text-blue-200 transition-colors flex items-center group">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div className={`font-bold text-lg md:text-xl transition-all ${
                isScrolled ? 'text-blue-900' : 'text-white'
              }`}>
                <span className="font-black text- from-blue-600 to-blue-800 ">MGIDLA</span> 
            ...
            >
              <span className={`text-sm font-medium ${isScrolled ? 'text-blue-900' : 'text-white'}`}>
            ...
            <nav className="hidden md:block">
              <ul className="flex space-x-1">
                <NavItem href="/" label="Home" icon={<Home size={16} />} isScrolled={isScrolled} />
                ...
                <NavItem href="/admissions" label="Admissions" icon={<GraduationCap size={16} />} isScrolled={isScrolled} />
                ...
                <NavItem href="/myhub" label="MyHub" icon={<Grid size={16} />} isScrolled={isScrolled} />
                <NavItem href="/contact" label="Contact Us" icon={<Phone size={16} />} isScrolled={isScrolled} />
