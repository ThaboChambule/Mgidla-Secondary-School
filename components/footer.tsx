...
import { MapPin, Mail, Phone, Facebook, Twitter, Linkedin, Instagram, ExternalLink } from 'lucide-react';
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <p className="text-blue-100 text-sm leading-relaxed">
              Committed to academic excellence and holistic development, empowering students to achieve their full potential since establishment.
            </p>
            <div className="pt-4">
              <Link 
                href="#about" 
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-blue-100 text-sm">Mhlungwane Area, Vryheid, KwaZulu-Natal, South Africa</p>
              </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              ...
              <p className="text-blue-200 text-sm">
                Website by <Link href="https://thabochambule.co.za" target="_blank" className="hover:text-white underline underline-offset-2">Thabo Chambule</Link>
              </p>
            </div>
          </div>
        </div>
