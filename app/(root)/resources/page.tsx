...
export default function Grade12Resources() {
  ...
  const lessonResources = [
    ...
    },
    {
      ...
      description:
        "Subject-specific resources to help Grade 12 learner with curriculum and assessment requirements",
    },
    {
    ...
    },
    {
      ...
      description:
        "Weekly lessons with embedded activities and resources for remote, blended and self-directed learning",
    },
    {
  ...
  const examPreparationResources = [
    ...
    },
    {
      ...
      description:
        "Guides providing notes, examples, problem-solving exercises with solutions",
    },
    {
    ...
    },
    {
      ...
      title: "FET Study Guides",
      description:
        "Use these study guides and booklets to help prepare for the exams",
    },
    {
    ...
    },
    {
      ...
      description:
        "Find the most commonly asked questions and answers regarding the National Senior Certificate",
    },
    {
  ...
  const additionalResources = [
    {
      ...
      description:
        "Adults qualifying to write the 2024 Senior Certificate examination must register",
    },
    {
      imageSrc: "/images/coding.jpg",
      title: "Coding and Robotics",
      description:
        "DBE Digital Skills Curriculum resources for finding your inner coder",
    },
    {
      imageSrc: "/images/prepare.jpg",
      title: "eAssessment Preparation",
      description:
        "Online exams to practice and prepare for National Senior Certificate",
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-12">
            <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto mb-6">
              Here is a collection of resources to support learning and teaching
              in grade 12. The resources span a variety of topics to keep
              learning fresh and exciting. These resources walk hand in hand
              with CAPS (Curriculum and Assessment Policy).
            </p>
            <blockquote className="text-center italic text-lg text-gray-600 max-w-2xl mx-auto">
              &ldquo;They cannot stop me. I will get my education, if it is in
              the home, school, or anyplace.&rdquo;
              <br />- Malala Yousafzai
            </blockquote>
          </section>
