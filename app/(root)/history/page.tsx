...
import { Calendar, Clock, History as HistoryIcon, Target, Users, ChevronRight } from "lucide-react";
...
const TimelineItem = ({ 
  ...
  <motion.div 
    ...
    viewport={{ once: true }}
    transition={{ duration: 0.5 }}
    className={`flex items-stretch ${align === "right" ? "flex-row-reverse" : ""}`}
  >
    <div className="hidden md:flex flex-col items-center">
      <div className="w-4 h-4 rounded-full bg-blue-600 z-10"></div>
      <div className="w-1 flex-grow bg-blue-300"></div>
    </div>
    <div className={`bg-white rounded-xl shadow-lg overflow-hidden md:w-5/12 mb-10 ${align === "left" ? "md:mr-auto" : "md:ml-auto"}`}>
      {imageSrc && (
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-950/80 to-blue-950/50 flex items-center">
            <div className="container mx-auto px-8">
              ...
              >
                ...
                <p className="text-xl mb-8">Tracing the journey and evolution of Mgidla Secondary School through the years.</p>
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed mb-6 text-center italic">
                "A school's history is more than dates and events — it's the story of countless lives shaped, 
                dreams nurtured, and a community united in the pursuit of knowledge."
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
        ...
        <section className="container mx-auto px-4 mb-20">
          <div className="bg-white rounded-xl shadow-xl p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-blue-900 mb-6">Looking to the Future</h2>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                Looking ahead, Mgidla Secondary School aims to continue its legacy of excellence by further enhancing 
                its facilities, expanding its academic programs, and fostering a culture of innovation and inclusivity. 
                The school is committed to preparing its students for the challenges of the future and ensuring that 
